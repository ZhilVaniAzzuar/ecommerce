...
<template>
    <section class="bg-white shadow-xl rounded-xl overflow-hidden">
        ...
        <div class="px-5 pb-5 pt-9 relative">
            <NuxtLink :to="`/product/${props.product.id}`" ><h3 class="text-lg fontbold mb-4 text-limit limit-2">{{ props.product.name }}</h3></NuxtLink>
            ...
            <div :class="`cursor-pointer absolute -top-5 right-7 w-[50px] h-[50px] bgwhite shadow-xl rounded-full flex justify-center items-center hover:bg-blue-600 hover:text-white transition duration-300`">
